...
public class YatzyPanel extends JPanel {
	...
	private void lagLayout() {
		...
		this.pnlButtons.add(this.btnKast, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 5), 0, 0));
		this.pnlButtons.add(this.btnNyRunde, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		this.pnlTerninger.add(this.lblTerninger, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 5), 0, 0));
		this.pnlTerninger.add(this.lblHoldTerninger, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 0, 0, 5), 0, 0));
		...
		for(int i=0; i<this.txtTerninger.length; i++) {
			...
			this.pnlTerninger.add(txtTerning, new GridBagConstraints(i+1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0, 5), 0, 0));
			this.pnlTerninger.add(chkHoldTerning, new GridBagConstraints(i+1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		}
		...
		this.pnlKombinasjonerOgPoeng.add(this.lblKastTeller, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 5), 0, 0));
		this.pnlKombinasjonerOgPoeng.add(this.txtkastTeller, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		this.pnlKombinasjonerOgPoeng.add(this.lblKombinasjoner, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(11, 0, 0, 5), 0, 0));
		this.pnlKombinasjonerOgPoeng.add(this.cbxKombinasjoner, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(11, 0, 0, 0), 0, 0));
		this.pnlKombinasjonerOgPoeng.add(this.lblPoengsum, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(11, 0, 0, 5), 0, 0));
		this.pnlKombinasjonerOgPoeng.add(this.txtPoengsum, new GridBagConstraints(1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(11, 0, 0, 0), 0, 0));
