...
public class YatzyPresentasjonsmodellImpl implements YatzyPresentasjonsmodell {
	...
	private void initModell() {
		...
		this.kombinasjonerModel = new SelectionInList<Yatzykombinasjon>(Yatzykombinasjon.values());
	...
	private void initActions() {
		...
		this.kombinasjonerModel.addPropertyChangeListener("selection", new PropertyChangeListener() {
			@Override
