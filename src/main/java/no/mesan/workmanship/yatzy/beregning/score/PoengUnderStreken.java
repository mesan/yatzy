...
public final class PoengUnderStreken {
    public static final KastBeregner P_SJANSE= new PoengSjanse();
    public static final KastBeregner P_LITEN_STRAIGHT= new PoengStraights(Straights.LITEN, SpesialPoeng.LITEN_STRAIGHT_POENG);
    public static final KastBeregner P_STOR_STRAIGHT= new PoengStraights(Straights.STOR, SpesialPoeng.STOR_STRAIGHT_POENG);
